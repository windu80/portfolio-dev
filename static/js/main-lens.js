...
var main = (function($) { var _ = {
	...
	initProperties: function() {
		...
		// Thumbnails.
		_.$thumbnails_1 = $('#thumbnails-1');

		// Thumbnails.
		_.$thumbnails_2 = $('#thumbnails-2');

		// Thumbnails.
		_.$thumbnails_3 = $('#thumbnails-3');

		// Thumbnails.
		_.$thumbnails_4 = $('#thumbnails-4');

		// Thumbnails.
		_.$thumbnails_5 = $('#thumbnails-5');
